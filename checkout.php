        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                                ...
                                <table class="table" style="font-size: small;">
                                    ...
                                    <tbody>
                                        <?php 
                                            $subtotal = 0;
                                            $subberattotal = 0;
                                            foreach ($_SESSION["cart"] as $uniq => $dataProduct) :
                                                $jumlah = $dataProduct['jumlah'];
                                                $ukuran = $dataProduct['ukuran'];
                                                $id_barang = $dataProduct['id_barang'];

                                            ?>
                                        <?php
                                            $query="SELECT * FROM tbl_produk WHERE id_produk='$id_barang'";
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-6 text-right">
                                       <span id="subtotalberat"
                                            name="subtotalberat"><?= $subberattotal; ?> Gram</span>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-sm-6">
                ...
                if (isset($_POST['pesan'])) {
                    ...
                    //simpat detail_order
                    $subberattotal2 = 0;
                    foreach ($_SESSION['cart'] as $uniq_id => $dataProduk) {
                        //mendapatkan data produk berdasarkan id_produk
                        $id_produk = $dataProduk['id_barang'];
                        $jumlah2 = $dataProduk['jumlah'];
                        $ukuran = $dataProduk['ukuran'];
                        $ambil="SELECT * FROM tbl_produk WHERE id_produk='$id_produk'";
                        ...
                        $subberattotal2 +=$berat2;

                        $query3 = "INSERT INTO tbl_detail_order (id_order,id_produk,nm_produk,harga,jml_order,ukuran,berat,subberat,subharga)
                            VALUES ('$id_order_barusan','$id_produk', '$nmProduk','$harga','$jumlah2','$ukuran','$berat','$subberat2','$subharga2' )";
                        $result3 = mysqli_query($db,$query3);
                        
                        //update stok
                        $query4 = "UPDATE tbl_produk SET stok=stok-$jumlah2 WHERE id_produk='$id_produk'";
        ...
        $("#city_destination").change(function () {
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    let ongkir = parseInt(data.ongkir);
                    let total = parseInt(data.total);
                    let formatted_ongkir = ongkir.toLocaleString('en-GB', {
                        maximumFractionDigits: 0
                    });
                    let formatted_total = total.toLocaleString('en-GB', {
                        maximumFractionDigits: 0
                    });
                    $("#ongkir_value").val(ongkir);
                    console.log(ongkir, formatted_ongkir);
                    $("#ongkir").html(formatted_ongkir);
                    $("#subtotal_value").val(total);
                    console.log(total, formatted_total);
                    $("#total").html(formatted_total);
                }
            });
        });
        // $("#city_destination").change(function () {
