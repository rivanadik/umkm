...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="d-block" src="assets/img/wbatik1.jpg" alt="First slide" width="100%" height="615px">
        ...
        <div class="carousel-item">
            <img class="d-block" src="assets/img/wbatik1.jpg" alt="Second slide" width="100%" height="615px">
            <div class="carousel-caption">
                <!-- <h3>New York</h3>
        ...
        <div class="carousel-item">
            <img class="d-block" src="assets/img/wbatik1.jpg" alt="Third slide" width="100%" height="615px">
            <div class="carousel-caption">
                <!-- <h3>New York</h3>
                    <p>We love the Big Apple!</p> -->
            </div>
...
<!--<div class="banner">
    <div class="container-fluid img text-white mt-3 mb-3"
        style="background-image: url(assets/img/wbatik2.jpg); background-size: cover;">
